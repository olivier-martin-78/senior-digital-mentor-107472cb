-- Modify the public mini site reviews function to return actual patient names and cities
...
AS $function$
  SELECT
    ...
    ir.client_comments,
    ir.created_at,
    ir.patient_name,  -- Return actual patient name instead of NULL
    NULL::text as auxiliary_name,  -- Keep auxiliary name private
    ir.client_city    -- Return actual client city instead of NULL
