-- Corriger la fonction get_admin_users_with_auth_data pour éviter les doublons
-- Le problème : LEFT JOIN avec user_roles crée une ligne par rôle, donc des doublons si un utilisateur a plusieurs rôles
