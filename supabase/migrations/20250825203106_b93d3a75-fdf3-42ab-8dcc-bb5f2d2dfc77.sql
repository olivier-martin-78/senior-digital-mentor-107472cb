-- Modifier la fonction get_dashboard_stats pour étendre les limites et ajouter l'email et date de dernière session
...
BEGIN
  ...
  -- 7. Sessions par utilisateur - avec email et date dernière session, limité aux 20 derniers avec au moins 1 session
