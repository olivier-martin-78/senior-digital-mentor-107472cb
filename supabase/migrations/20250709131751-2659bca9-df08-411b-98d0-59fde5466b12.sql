...
BEGIN
  ...
  IF new_group_id IS NULL THEN
    ...
    -- CORRECTION: Ajouter automatiquement le créateur comme membre avec le rôle 'admin'
    INSERT INTO public.group_members (group_id, user_id, role)
    VALUES (new_group_id, NEW.invited_by, 'admin');
  END IF;
...
INSERT INTO public.group_members (group_id, user_id, role)
SELECT ig.id, ig.created_by, 'admin'
