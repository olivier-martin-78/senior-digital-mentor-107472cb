    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          <Card className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/10 dark:to-purple-900/10 border-primary/20">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <Brain className="h-5 w-5 text-primary" />
                    <h3 className="text-lg font-semibold text-foreground">Boostez votre mémoire</h3>
                    <Badge variant="secondary" className="bg-primary/10 text-primary text-xs">
                      50 jeux cognitifs
                    </Badge>
                  </div>
                  <p className="text-sm text-muted-foreground mb-4">
                    Stimulez votre mémoire, attention et réactivité avec nos jeux scientifiquement conçus.
                  </p>
