      ...
      <div className="container">
        ...
        <div className="max-w-2xl mx-auto text-center animate-on-scroll">
          <p className="text-lg text-tranches-charcoal/90 mb-6">
            ...
            <li>Nous mettons à la disposition de nos mentors digitaux notre application CaprIA qui permet à nos aînés de produire du contenu digital et de le partager au sein de leur cercle familial.</li>
          </p>
        </div>
      </div>
    </section>
